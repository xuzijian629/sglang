...
def latency_test(
    ...
    if get_bool_env_var("SGLANG_SET_CPU_AFFINITY"):
        set_gpu_proc_affinity(cfg.pp_size, cfg.tp_size, cfg.nnodes, tp_rank)
...
def main(server_args, bench_args):
    # The decode phase captures for the batch sizes this run benchmarks; the
    # per-phase knob is raw input, so it is set before resolution parses it.
